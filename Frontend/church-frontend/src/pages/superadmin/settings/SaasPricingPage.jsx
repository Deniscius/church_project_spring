...
export default function SaasPricingPage() {
  ...
  const save = async (plan) => {
    ...
    try {
      ...
      // Le backend garantit qu’un seul plan peut être recommandé : recharge silencieuse
      // pour récupérer l’état exact des autres cartes sans faire disparaître la page.
      if (saved.featured) {
